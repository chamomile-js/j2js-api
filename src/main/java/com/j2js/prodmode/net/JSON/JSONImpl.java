...
import javascript.JSIterator;
import javascript.JSIteratorEntry;
import javascript.JSObject;
import javascript.ScriptHelper;

public final class JSONImpl extends AbstractJSON {

	public static HashMap<String, Object> create(Object theNativeObject) {
		HashMap<String, Object> map = new HashMap<String, Object>();
		JSObject o = new JSObject(theNativeObject);
		for (JSIterator i = o.iterator(); i.hasNext();) {
			JSIteratorEntry e = i.next();
